    ...
    <header class="views-navbar" :class="{'trans-bg': transBg, 'font-base': !isHome}">
        <div class="views-navbar-wrapper" :class="{hide: navbarHide}">
            ...
            <nav class="container views-navbar-nav">
                ...
                <a class="views-navbar-item" href="https://github.com/Evansy" target="_blank" rel="noopener noreferrer nofollow" title="github">
                    <i class="iconfont icon-git"></i>
                </a>
                <a class="views-navbar-item" href="https://weibo.com/sk608" target="_blank" rel="noopener noreferrer nofollow" title="微博">
